...
export default {
  ...
  data() {
    return {
      erc20: '0xa5bD401889F664c56A54E031296EDc78fce200C3',
      selectedAddress: 'cosmos1lpecjwz5363cgg4mpmrum4draxx00npjsf6zpn',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1lpecjwz5363cgg4mpmrum4draxx00npjsf6zpn')
